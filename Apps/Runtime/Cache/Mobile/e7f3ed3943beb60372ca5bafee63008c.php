	...
	<div class="mainBox">
		<div class="doctorRecommend">
			...
			<div class="hospitalRecommendTwo">
				<a href="http://192.168.1.21/Hope-three/index.php/Mobile/Index/hospitalList">
					<div class="hospitalRecommendList">
						<div class="hospitalRecommendDiv"><img class="hospitalRecommendImg" src="/Hope-three/Public/Mobile/image/20180615banner2.jpg"></div>
				...
				<div class="hospitalRecommendList">
					<div class="hospitalRecommendDiv"><img class="hospitalRecommendImg" src="/Hope-three/Public/Mobile/image/20180615banner3.jpg"></div>
					<div class="hospitalRecommendName">日本顺天堂大学附属医院</div>
					<div class="hospitalRecommendAbstract">幕内雅敏幕内雅敏幕内雅敏幕内雅敏幕内雅敏幕内雅敏</div>
				</div>
				<div class="hospitalRecommendList">
		...
		<div class="countryDepartment"> 
			...
			<div class="departments" data-n="1">
				<div class="department"><div class="departmentImg"><img src="/Hope-three/Public/Mobile/image/20180626zhongliuke.png"></div><div class="departmentTitle">肿瘤科</div></div>
